<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrakTagInfo.aspx.vb" Inherits="TrakTagInfo" %>
            ...
            <table align="center" id="tblImportVehs" runat="server" class="FiveHundredPXTable">
                <tr>
                    <td colspan="2" class="MainHeader">
                        <asp:Label ID="lblHeader" runat="server" Text="Import TAG Information from TRAK Tag file"></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td id="TDButtons" runat="server" class="VehicleTD" style="text-align: left;">
                    ...
                    <td class="Dept_Grid_TD" align="center">
                        <asp:GridView ID="gvImportVehs" Width="900PX" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="75px" ItemStyle-HorizontalAlign="Left" HeaderText="Sysno">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSysNo" Text='<%# DataBinder.Eval(Container.DataItem, "Sys_Nbr")%>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
