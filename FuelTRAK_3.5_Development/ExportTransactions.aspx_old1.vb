        ...
        Try
            ...
            If DateDiff(DateInterval.Day, GenFun.ConvertDate(txtStartDate.Text.Trim()), GenFun.ConvertDate(txtEndDate.Text.Trim())) >= 0 Then
                ...
                If (sqlRdr.HasRows = True) Then
                    ...
                    If (chkPrevTxtns.Checked = True) Then query = query & " and (downloaded>=0 or downloaded is null )" Else query = query & " and (downloaded = 0 or downloaded is null)  and Export1 is null"
