<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ExcelImport.aspx.vb" Inherits="ExcelImport" %>
              ...
              <td colspan= "2" style="height:50px">
                ...
                <tr>
                    <td colspan="2" class="MainHeader">
                        <asp:Label ID="lblHeader" runat="server" Text=" Excel Import"></asp:Label></td>
                </tr>
