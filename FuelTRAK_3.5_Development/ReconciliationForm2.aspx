<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ReconciliationForm2.aspx.vb" Inherits="ReconciliationForm2" %>
    ...
    <form id="form2" runat="server">
        <div>
            <table align="center" width="800px">
                <tr>
                    <td></td>
                    <td class="MainHeader" colspan="3" style="height: 42px">
                            <asp:GridView ID="gvReconciliation" runat="server" Width="800px" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField SortExpression="PUMP_TOTALIZERS" ItemStyle-HorizontalAlign="Center"
                                        ItemStyle-Width="148px" HeaderText="AMOUNT DISPENSED(Totalizer)" HeaderStyle-Wrap="true"
                                    ...
                                    <asp:TemplateField SortExpression="PUMP_TOTALIZERS" ItemStyle-HorizontalAlign="Center"
                                        ...
                                        HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGVPumpTot2" Text='<%# DataBinder.Eval(Container.DataItem, "DSP2")%>'
                                                runat="server">
                                            </asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField SortExpression="TANK_DELIVERIES" ItemStyle-HorizontalAlign="Center"
                                        ItemStyle-Width="148px" HeaderText="INPUT Deliveries" HeaderStyle-Wrap="true"
                                        HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField SortExpression="TANK_LEVELS" ItemStyle-HorizontalAlign="Center"
                                        ItemStyle-Width="148px" HeaderText="TANK VOLUME">
                                        <ItemTemplate>
                    ...
                    <td class="MainHeader" colspan="4" style="height: 42px; text-align: right">
                        <asp:Button ID="btnRunReport" runat="server" Text="Run Report"  CssClass="MainHeader" Height="31px" Width="126px" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 301px">
                        <asp:TextBox ID="txtDateYear" runat="server" CssClass="ReconFormTxtBoxTop"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="width: 250px">
                    ...
                    <td style="width: 301px; text-align: left">
            ...
            <table align="center" width="800px">
                <tr style="height: 15px">
                    ...
                    <td style="width: 148px">
                        <asp:Label ID="lblColD" runat="server" Text="Label" CssClass="ReconFormLableCenter">COLUMN D</asp:Label></td>
                </tr>
                <tr>
                    <td style="width: 75px">
                    </td>
                    ...
                    <td style="width: 148px">
                        <asp:Label ID="Label1" runat="server" Font-Size="x-small" Text="Label" Width="150px">AMOUNT DISPENSED</asp:Label></td>
                    <td style="width: 148px">
                ...
                <tr style="height: 15px">
                    ...
                    <td style="width: 148px">
                        <asp:Label ID="Label5" runat="server" Font-Size="x-small" Text="Label" Width="150px">DISPENSER 1</asp:Label></td>
                    <td style="width: 148px">
                        <asp:Label ID="Label4" runat="server" Font-Size="x-small" Text="Label" Width="150px">DISPENSER 2</asp:Label></td>
                    <td style="width: 148px">
                ...
                <tr>
                    ...
                    <td style="width: 148px; height: 22px;">
                        <asp:TextBox ID="txtPrevMntAmtCnt2" runat="server" Font-Size="x-small" Height="10px"></asp:TextBox></td>
                    <td style="width: 148px; height: 22px;">
                        &nbsp;</td>
                    <td>
            ...
            <table align="center" width="800px">
                <tr>
                    ...
                    <td style="width: 148px">
                        ...
                        <asp:Label ID="Label19" runat="server" Text="Label" CssClass="ReconFormTxtBoxLabel">1A</asp:Label></td>
                    <td><asp:TextBox ID="txtCntColB" runat="server" Height="10px" Font-Size="x-small"></asp:TextBox>
                        <asp:Label ID="Label2" runat="server" Text="Label" CssClass="ReconFormTxtBoxLabel">1B</asp:Label></td>
                    ...
                    <td style="width: 148px; text-align: right">
                        <asp:TextBox ID="txtCntColD" runat="server" Height="10px" Font-Size="x-small"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align: center">
                        <asp:TextBox ID="txtCntColAB" runat="server" Height="10px" Font-Size="x-small"></asp:TextBox>
                        <asp:Label ID="Label3" runat="server" CssClass="ReconFormTxtBoxLabel" Text="Label">1</asp:Label></td>
                    <td></td>
                </tr>
            </table>
            <table align="center" width="800px">
